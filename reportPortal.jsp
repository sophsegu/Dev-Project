...
<head>
  ...
  <link rel="stylesheet" href="largeFormat4.css?version=7">
...
<button class="btn"><i class="fa fa-address-card"></i></button>
  ...
  <div class="admin-page">
    <div class="form">
      ...
      <div class="container">
      <form method="post" action="Admin">
          <input type="hidden" name="method" value="searchReports">
	...
	<table>
		<tr>
			...
			<th width="10%">Date</th>
			<th width="20%">Room Numbers</th>
			<th width="25%">Names</th>
			<th width="10%">Open Report</th>
		</tr>
