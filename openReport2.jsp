      ...
      <div class="col-lg-8">
        ...
        <form method="post" action="Admin" enctype="multipart/form-data">
          ...
          <td><input type="date" value=<%=request.getAttribute("date_of_incident") %> name="date_of_incident" required></td>
            ...
            Report:
          <textarea name="report" rows="8" cols="133" readonly><%=request.getAttribute("report") %></textarea>
          Response:
          <textarea name="response" rows="8" cols="133" readonly><%=request.getAttribute("response") %></textarea>
          </form>
          </div>
        </div>
        </div>
