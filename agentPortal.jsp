...
<head>
  ...
  <link rel="stylesheet" href="largeFormat.css?version=47">
  ...
  <div class="admin-page">
    <div class="form">
      ...
      <div class="container">
        ...
        <form method="post" action="Agent">
        <input type="hidden" name="method" value="addNewResident" >
            <button class="button" type="submit">Add New Resident</button>
            </form>
            <form method="post" action="Agent">
        <input type="hidden" name="method" value="writeReport" >
            <button class="button" type="submit">Write Report</button>
            </form>
      </div>
      <br>
