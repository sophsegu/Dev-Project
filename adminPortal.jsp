...
<head>
  ...
  <link rel="stylesheet" href="largeFormat4.css?version=9">
      ...
      <form method="post" action="Admin">
          <input type="hidden" name="method" value="search">
            <select name="searchField">
              ...
              <option value="date_of_modification">Date</option>
            </select>
        ...
        <form method="post" action="Admin">
        <input type="hidden" name="method" value="modifyAgent" >
            <button class="button" type="submit">Modify Users</button>
            </form>
            <form method="post" action="Admin">
        <input type="hidden" name="method" value="modifyRoom" >
            <button class="button" type="submit">Modify Rooms</button>
            </form>
      </div>
      <br>
	<table>
