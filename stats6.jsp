    ...
    <div class="row">
      <div class="col-lg-8">
        ...
        <h3>   </h3>
              ...
              <button class="button">Employment Challenges</button>
              </div>
              <form method="post" action = "Admin">
              <input type="hidden" name="method" value="stats">
...
<script>
const xArray = ["Tranportation", "Childcare", "Language", "Layoff", "Medical", "Still in School", "Pregnant", "ODSP", "Reunification", "Other"];
const yArray = [<%=request.getAttribute("Transporation")%>, <%=request.getAttribute("Childcare")%>, <%=request.getAttribute("Language")%>, <%=request.getAttribute("Layoff")%>, <%=request.getAttribute("Medical")%>, <%=request.getAttribute("Still in School")%>, <%=request.getAttribute("Pregnant")%>, <%=request.getAttribute("ODSP")%>, <%=request.getAttribute("Recertification")%>, <%=request.getAttribute("Other")%>];
...
const layout = {title:"Employment Challenges"};
